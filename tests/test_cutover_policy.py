...
class CutoverPolicyTests(unittest.TestCase):
    def test_default_mode_is_legacy(self) -> None:
        self.assertEqual(normalize_planning_engine_mode(None), LEGACY_MODE)
        self.assertEqual(normalize_planning_engine_mode(""), LEGACY_MODE)
    ...
    def test_unknown_mode_falls_back_to_legacy(self) -> None:
        self.assertEqual(normalize_planning_engine_mode("pure"), LEGACY_MODE)
