...
def install_resource_local_preferences() -> None:
    if getattr(ui_module.PlannerUI, "_resource_local_preferences_installed", False):
        return

    legacy_order_reader = resource_management._resource_order_map
    resource_management._resource_order_map = _local_order_map_factory(legacy_order_reader)
    resource_management._manual_order_dialog = _manual_order_dialog_local
    resource_management._new_resource_dialog = _new_resource_dialog_local
    sorting_compat.move_manual_resource = _move_manual_resource_local
    ui_module.PlannerUI.move_resource_manual = _move_manual_resource_local

    ui_module.PlannerUI._resource_local_preferences_installed = True
